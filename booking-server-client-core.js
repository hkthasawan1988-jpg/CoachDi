(function (root, factory) {
  ...
  const ERROR_MESSAGES = Object.freeze({
    ...
    TIME_CONFLICT: 'เวลาชนกับตารางเดิม ช่วงเวลานี้ไม่ว่างแล้ว กรุณาเลือกเวลาใหม่',
    ...
    INVALID_SCHEDULE_COMMAND: 'ข้อมูลคำสั่งตารางไม่ถูกต้อง กรุณาเปิดตารางใหม่',
    INVALID_TIME_OFF: 'กรุณาเลือกช่วงวันหยุดตั้งแต่วันนี้เป็นต้นไป',
    INVALID_APPOINTMENT: 'กรุณาตรวจวัน เวลา และชื่อสนามอีกครั้ง',
    TIME_OFF_OVERLAP: 'ช่วงวันที่เลือกทับวันหยุดเดิม กรุณาแก้ไขรายการเดิม',
    SCHEDULE_CHANGED: 'รายการตารางเปลี่ยนแล้ว กรุณาโหลดตารางใหม่',
    SCHEDULE_ID_CONFLICT: 'รายการตารางนี้ถูกบันทึกแล้ว กรุณาโหลดตารางใหม่',
    RECURRENCE_LIMIT: 'ตารางประจำสร้างได้ไม่เกิน 52 สัปดาห์',
    TIME_OFF_NOT_FOUND: 'ไม่พบวันหยุดนี้ กรุณาโหลดตารางใหม่',
    APPOINTMENT_NOT_FOUND: 'ไม่พบนัดนี้ กรุณาโหลดตารางใหม่',
  });
